...
What Does Normal Look Like?
 ...
 How much daily traffic?  Google, Facebook, Twitter, Youtube, Baidu, etc. have a lot!  (every day!)
 But how much daily traffic for other sites?  (it's like our version of Alexa...)
...
SSL Certificate Laziness
 ...
 The certificate is only valid for ssl10.ovh.net (Error code: ssl_error_bad_cert_domain)  ohayons.com uses an invalid security certificate:
 The certificate expired on 07/24/2011. (Error code: sec_error_expired_certificate)  voigt-its.de uses an invalid security certificate:
