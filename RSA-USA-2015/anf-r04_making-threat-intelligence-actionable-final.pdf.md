...
Block compromised host Block compromised host Block compromised host Block compromised host Contain compromised host Contain compromised host Tag host as suspicious and inspect through IPS Tag host as suspicious and inspect through IPS Inspect host traffic through IPS Inspect host traffic through IPS
...
#RSAC
Network actions
 Investigate  Inspect with IPS: SPAN, TAP, SDN copying or redirection  Netflow/IPFIX monitoring  Packet capture
...
#RSAC
Poll
What is STIX?  Structured Threat Information eXchange  Structured Threat Information eXpression  Some Thing In XML
https://pollev.com/mrti
19
...
Indicator - SuggestedCOA Incident - RequestedCOA Incident - COATaken

Action target

Cybox Observable tied to 1. Cybox Observable
...
· Email addresses, subjects · Files · DNS domain names
...
1. Cybox Observable tied to Incident
2. Incident Victim
...
Other requirements
 ...
 Security Group Policy enforcer  Network devices that can handle tags
