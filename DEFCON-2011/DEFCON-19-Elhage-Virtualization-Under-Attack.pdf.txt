...
... f w c f g = f w c f g i n i t ( BIOS CFG IOPORT , BIOS CFG IOPO
f w c f g a d d b y t e s ( f w c f g , FW CFG E820 TABLE , ( u i n t 8 sizeof ( struct e820 table ));
f w c f g a d d b y t e s ( f w c f g , FW CFG HPET , ( u i n t 8 t *)& sizeof ( struct hpet fw config ));
