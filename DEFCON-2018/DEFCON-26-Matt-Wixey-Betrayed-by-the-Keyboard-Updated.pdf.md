...
· Two VMs, exposed on the internet (SSH) · One account per user per box · Deliberate privesc vulnerabilities · Plus fake data to exfiltrate
PwC  50
...
· This is more about attribution via linkage · Could be used to link you to historical/future activity · Used to build up repository of command profiles
PwC  79
...
Note on Google Translate · @InsightfulRobot)created by colleague Keith Short (@ItsNotKeith) · Turns: People who succeed have momentum. The more they succeed, the
more they want to succeed, and the more they find a way to succeed. Similarly, when someone is failing, the tendency is to get on a downward spiral that can even become a self-fulfilling prophecy.
· into:
PwC  81

Note on Google Translate
· English -> Norwegian · Norwegian -> French · French -> Afrikaans · Afrikaans -> Romanian · Romanian -> Japanese · Japanese -> English
