Breaking WingOS
Josep Pi Rodriguez Senior Security Consultant Josep.rodriguez@ioactive.com
1
...
Attack Surface & Scenarios
Ruben Santamarta Last call for satcom security
IOhActttivpes, I:n/c/.wCowpywrig.hbt ©la20c1k8.hAall tR.icghotsmRe/suersve-d1. 8/briefings.html#last-call-for-satcom-security
...
Remote Pre-auth stack overflow (mint)
LIBC sanity checks can make it crash before the stack overflow happens In this case is not a problem as it won't crash if we trigger the stack overflow "quickly"
IOActive, Inc. Copyright ©2018. All Rights Reserved.
...
josep.rodriguez@ioactive.com info@ioactive.com
87
